...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update = $pdo->prepare("UPDATE admins SET username=?, password=?, profile_pic=? WHERE id=?");
    $update->execute([$username, $password, $profile_pic, $admin_id]);
...
<div class="sidebar" id="sidebar">
  ...
  <ul class="sidebar-menu">
    ...
    <li><a href="view.php"><i class="fas fa-users"></i> Students</a></li>
